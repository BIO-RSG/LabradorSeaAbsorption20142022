...
#
col.dat$min = apply(col.dat,1,min)
col.dat$max = apply(col.dat,1,max)
col.dat$LCB =  (col.dat$LCB - col.dat$min)/(col.dat$max-col.dat$min)
col.dat$DDS =  (col.dat$DDS - col.dat$min)/(col.dat$max-col.dat$min)
col.dat$HPB =  (col.dat$HPB - col.dat$min)/(col.dat$max-col.dat$min)
col.dat$MPB =  (col.dat$MPB - col.dat$min)/(col.dat$max-col.dat$min)
##
col.dat$LCB.col = cubicl(4)[2]
col.dat$LCB.tran = alpha(col.dat$LCB.col,col.dat$LCB )
#
col.dat$DDS.col = cubicl(4)[3]
col.dat$DDS.tran = alpha(col.dat$DDS.col,col.dat$DDS)
#
col.dat$HPB.col = cubicl(4)[1]
col.dat$HPB.tran = alpha(col.dat$HPB.col,col.dat$HPB)
#
col.dat$MPB.col = cubicl(4)[4]
col.dat$MPB.tran = alpha(col.dat$MPB.col,col.dat$MPB)
#
#
b = test[unique(a)]
#
...
##
png("./Figures/00_StudyAreaMAp.png",width=6.2,height=5, units = "in",res=300,pointsize = 10 )
...
plot(bathy,step=1000, deep=-3000,shallow=-1000,drawlabels=T,
     n=3,add=T)
...
shape::colorlegend(posx = c(0.86, 0.895), left = F, col =in.col, 
                   main="N (%)",
