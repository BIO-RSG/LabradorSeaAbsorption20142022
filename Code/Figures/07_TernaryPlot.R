...
options(scipen=5)
#Ternary Plot
png("./Figures/07_TernaryPlot.png",
...
in.plot = na.omit(in.plot)
abs.list = as.list(as.data.frame(t(in.plot[,c("CDOMPer","PhytoPer" ,"DetPer")])))
TernaryPlot(blab=expression("a"['PHY']* " (470) (%)"), 
            clab = expression("a"['NAP']* " (470) (%)"), 
            alab=expression("a"['CDOM']* " (470) (%)"),cex=1,padding=0.01,lab.offset = 0.11)
in.col = alpha(cubicl(4),0.8)
in.col.plot = ifelse(in.plot$regime=="Basin" ,in.col[2],
                     ifelse(in.plot$regime=="Shelf" ,in.col[3],
                            ifelse(in.plot$regime=="HighPhaeo" ,in.col[1],in.col[4])))
...
in.plot = na.omit(in.plot)
abs.list = as.list(as.data.frame(t(in.plot[,c("CDOMPer","PhytoPer" ,"DetPer")])))
TernaryPlot(blab=expression("a"['PHY']* " (570) (%)"), 
            clab = expression("a"['NAP']* " (570) (%)"), 
            alab=expression("a"['CDOM']* " (570) (%)"),cex=1,padding=0.01,lab.offset = 0.11)
in.col = alpha(cubicl(4),0.8)
in.col.plot = ifelse(in.plot$regime=="Basin" ,in.col[2],
                     ifelse(in.plot$regime=="Shelf" ,in.col[3],
                            ifelse(in.plot$regime=="HighPhaeo" ,in.col[1],in.col[4])))
...
in.plot = na.omit(in.plot)
abs.list = as.list(as.data.frame(t(in.plot[,c("CDOMPer","PhytoPer" ,"DetPer")])))
TernaryPlot(blab=expression("a"['PHY']* " (675) (%)"), 
            clab = expression("a"['NAP']* " (675) (%)"), 
            alab=expression("a"['CDOM']* " (675) (%)"),cex=1,padding=0.01,lab.offset = 0.11)
in.col = alpha(cubicl(4),0.8)
in.col.plot = ifelse(in.plot$regime=="Basin" ,in.col[2],
                     ifelse(in.plot$regime=="Shelf" ,in.col[3],
                            ifelse(in.plot$regime=="HighPhaeo" ,in.col[1],in.col[4])))
